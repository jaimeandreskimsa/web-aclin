      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/80">
            ...
            <li><Link href="/metodologias" className="hover:text-white transition">Metodologías</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/80">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="tel:323323600" className="hover:text-white transition">32 33 23 600</a>
            </li>
            <li className="flex items-center gap-2">
            ...
            <li className="flex items-start gap-2">
              <Clock size={15} className="mt-0.5 shrink-0 text-white" />
              <span>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/profile.php?id=61566541113740&mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full border-2 border-white flex items-center justify-center hover:bg-white hover:text-[#087849] transition text-white">
