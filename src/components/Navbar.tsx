    ...
    <nav className="bg-[#087849] sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-20">
        <Link href="/" className="flex items-center">
          <Image src="/logo-bn.png" alt="Aclin Laboratorio Clínico" width={100} height={33} className="object-contain" priority />
        </Link>
        ...
        {/* Mobile: Ver Resultados + hamburguesa */}
        <div className="md:hidden flex items-center gap-4">
          <a
            href="https://pacientes.aclin.cl/resultados/"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white text-[#087849] px-3 py-1.5 rounded-full text-xs font-bold hover:bg-green-50 transition"
          >
            Ver Resultados
          </a>
